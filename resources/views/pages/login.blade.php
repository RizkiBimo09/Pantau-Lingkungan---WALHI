...
<section class="lapor pt-36">
    ...
    <div class="max-w-xl mx-auto text-center mt-10 ">
      <h1 class="font-bold text-3xl font-Inter text-green2 md:text-3xl lg:text-5xl mb-14">Login</h1>         
    </div>
    </div>
</section>
{{-- end title page --}}
...
<section class="artikel pb-96">
    ...
    <div class="w-full px-4 text-center mb-10">
        <button type="submit" class="text-xl font-semibold bg-green2 py-3 px-8 rounded-full hover:shadow-lg  hover:opacity-80 transition duration-300 ease-in-out">Login</button>
        <a href="/register" class="cursor-pointer text-xl font-semibold bg-green2 py-3 px-8 rounded-full hover:shadow-lg  hover:opacity-80 transition duration-300 ease-in-out">Register</a>
    </div>
    </form>
    </div>
    </section>
