...
<section class="plingkungan pt-36">
    ...
    <div class="max-w-xl mx-auto text-center mt-10">
      ...
      <a href="/pLingkungan"><h1 class="font-bold text-xl font-Inter text-white md:text-3xl lg:text-2xl mb-16 inline-block mr-5 text-center">Indonesia </h1></a>      
...
<section class="plingkungan ">
    ...
    <div class="max-w-xl mx-auto text-justify mt-10">
      <h4 class="font-bold text-xl font-Inter text-white md:text-3xl lg:text-3xl mb-10 text-center"> LINGKUNGAN </h4>
